/*
 * This file is derived from the starkgate-contracts repository.
 * For source details and modifications, see ORIGINAL_AUTHORS.md
 */

// SPDX-License-Identifier: Apache-2.0.
pragma solidity ^0.8.20;

import "src/eic/StarknetTokenStorage.sol";
import "src/starkware/solidity/interfaces/ExternalInitializer.sol";
import "src/starkware/solidity/interfaces/Identity.sol";
import "src/starkware/solidity/libraries/NamedStorage.sol";
import "src/starkware/solidity/libraries/RolesLib.sol";
import "src/eic/WithdrawalLimit.sol";
...
contract ConfigureSingleBridgeEIC is ExternalInitializer, StarknetTokenStorage {
    ...
    function initialize(bytes calldata data) external virtual override {
        ...
        // Note(Mehul): This is commented out as we are using the new Proxy from Starkware.
        // which does the roles initialization while deploying the Proxy itself in the constructor.
        // Hence, we don't need to initialize the roles here.
