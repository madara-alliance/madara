...
pub(super) fn process_addresses_with_storage_diffs(
...
pub(super) fn process_addresses_without_storage_diffs(
    ...
    let leftover_addresses =
        collect_addresses_without_storage_diffs(processed_addresses, deployed_contracts, replaced_classes, nonces);
    tracing::debug!(
...
pub(super) fn add_declared_classes_to_blob_data(mut declared_classes: Vec<DeclaredClassItem>, blob_data: &mut Vec<Felt>) {
