...
impl JobTrigger for DataSubmissionJobTrigger {
    ...
    async fn run_worker(&self, config: Arc<Config>) -> color_eyre::Result<()> {
        trace!(log_type = "starting", category = "DataSubmissionWorker", "DataSubmissionWorker started.");
        ...
        trace!(log_type = "completed", category = "DataSubmissionWorker", "DataSubmissionWorker completed.");
        Ok(())
    }
}
