...
register_metric!(MOCK_METRICS, MockMetrics);
...
pub struct MockMetrics {
    ...
    pub fact_registered_total: Counter<f64>,
...
impl Metrics for MockMetrics {
    fn register() -> Self {
        ...
        Self {
            ...
            fact_registered_total: register_counter_metric_instrument(
                &meter,
                "mock_fact_registered_total".to_string(),
