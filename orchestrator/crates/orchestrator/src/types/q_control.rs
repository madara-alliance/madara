...
impl QueueControlConfig {
    pub fn default_with_message_count(max_message_count: u32) -> Self {
        Self {
            max_message_count: Some(max_message_count),
            retry_count: 3,
            retry_delay: 0,
        }
    }
...
lazy_static! {
    pub static ref QUEUES: HashMap<QueueType, QueueConfig> = {
        ...
        map.insert(QueueType::JobHandleFailure, QueueConfig {
            visibility_timeout: 300,
            dlq_config: None,
            queue_control: None,
            supported_layers: vec![Layer::L2, Layer::L3]
        });
        map.insert(QueueType::WorkerTrigger, QueueConfig {
            visibility_timeout: 300,
            dlq_config: None,
            queue_control: Some(QueueControlConfig::default_with_message_count(50)),
            supported_layers: vec![Layer::L2, Layer::L3]
        });
        map.insert(QueueType::SnosJobProcessing, QueueConfig {
            visibility_timeout: 300,
        ...
        map.insert(QueueType::SnosJobVerification, QueueConfig {
            visibility_timeout: 300,
            dlq_config: Some(DlqConfig { max_receive_count: 5, dlq_name: QueueType::JobHandleFailure }),
            queue_control: Some(QueueControlConfig::default_with_message_count(5)),
            supported_layers: vec![Layer::L2, Layer::L3]
        });
        map.insert(QueueType::ProvingJobProcessing, QueueConfig {
            visibility_timeout: 300,
            dlq_config: Some(DlqConfig { max_receive_count: 5, dlq_name: QueueType::JobHandleFailure }),
            queue_control: Some(QueueControlConfig::new(None, 3, 30)),
            supported_layers: vec![Layer::L2, Layer::L3]
        });
        map.insert(QueueType::ProvingJobVerification, QueueConfig {
            visibility_timeout: 300,
            dlq_config: Some(DlqConfig { max_receive_count: 5, dlq_name: QueueType::JobHandleFailure }),
            queue_control: Some(QueueControlConfig::new(None, 300, 30)),
            supported_layers: vec![Layer::L2, Layer::L3]
        });
        map.insert(QueueType::ProofRegistrationJobProcessing, QueueConfig {
            visibility_timeout: 300,
            dlq_config: Some(DlqConfig { max_receive_count: 5, dlq_name: QueueType::JobHandleFailure }),
            queue_control: Some(QueueControlConfig::new(None, 300, 30)),
            supported_layers: vec![Layer::L3]
        });
        map.insert(QueueType::ProofRegistrationJobVerification, QueueConfig {
            visibility_timeout: 300,
            dlq_config: Some(DlqConfig { max_receive_count: 5, dlq_name: QueueType::JobHandleFailure }),
            queue_control: Some(QueueControlConfig::new(None, 300, 30)),
            supported_layers: vec![Layer::L3]
        });
        map.insert(QueueType::DataSubmissionJobProcessing, QueueConfig {
            visibility_timeout: 300,
            dlq_config: Some(DlqConfig { max_receive_count: 5, dlq_name: QueueType::JobHandleFailure }),
            queue_control: Some(QueueControlConfig::new(None, 3, 60)),
            supported_layers: vec![Layer::L2, Layer::L3]
        });
        map.insert(QueueType::DataSubmissionJobVerification, QueueConfig {
            visibility_timeout: 300,
            dlq_config: Some(DlqConfig { max_receive_count: 5, dlq_name: QueueType::JobHandleFailure }),
            queue_control: Some(QueueControlConfig::new(None, 3, 60)),
            supported_layers: vec![Layer::L2, Layer::L3]
        });
        map.insert(QueueType::UpdateStateJobProcessing, QueueConfig {
            visibility_timeout: 900,
            dlq_config: Some(DlqConfig { max_receive_count: 5, dlq_name: QueueType::JobHandleFailure }),
            queue_control: Some(QueueControlConfig::new(None, 3, 60)),
            supported_layers: vec![Layer::L2, Layer::L3]
        });
        map.insert(QueueType::UpdateStateJobVerification, QueueConfig {
            visibility_timeout: 300,
            dlq_config: Some(DlqConfig { max_receive_count: 5, dlq_name: QueueType::JobHandleFailure }),
