...
//!    during the block lifecycle: on_finalize, on_initialize, on_runtime_upgrade, and
//!    offchain_worker.
//!
...
//!    FeeTokenAddress. These storage items are used to store and manage data related to the
//!    Starknet pallet.
//!
