...
pub struct Metrics {
    pub _block_number: Result<u64, String>,
    pub _syncing: Result<SyncStatusType, String>,
    pub _cpu_name: String,
    pub cpu_usage: Vec<f64>,
    pub memory_usage: Vec<u64>,
    pub total_memory: u64,
    pub _disk_name: String,
    pub disk_size: u64,
    pub disk_usage: u64,
...
impl App {
    pub fn new(storage_path: &str, logs_rx: tmpsc::Receiver<String>) -> Result<Self, String> {
        ...
        Ok(Self {
            ...
            data: Metrics {
                _block_number: Ok(0),
                _syncing: Ok(SyncStatusType::NotSyncing),
                _cpu_name: "unknown".to_string(),
                cpu_usage: vec![0.; 100],
                memory_usage: vec![0; 100],
                total_memory,
                _disk_name: "unknown".to_string(),
                disk_size: 0,
                disk_usage: 0,
                available_storage: 0,
                rx_flow: vec![0.; 100],
