...
impl ChainConfig {
    ...
    pub fn starknet_mainnet() -> Self {
        ...
        Self {
            ...
            versioned_constants: [
                (StarknetVersion::VERSION_0_13_0, BLOCKIFIER_VERSIONED_CONSTANTS_0_13_0.deref().clone()),
                (StarknetVersion::VERSION_0_13_1, BLOCKIFIER_VERSIONED_CONSTANTS_0_13_1.deref().clone()),
                (StarknetVersion::VERSION_0_13_1_1, BLOCKIFIER_VERSIONED_CONSTANTS_0_13_1_1.deref().clone()),
                (StarknetVersion::VERSION_0_13_2, VersionedConstants::latest_constants().clone()),
            ]
            .into(),

            eth_core_contract_address: eth_core_contract_address::MAINNET.parse().expect("parsing a constant"),

            latest_protocol_version: StarknetVersion::VERSION_0_13_2,
