...
impl InitialBalances {
    #[tracing::instrument(skip(self, contract_address, bal), fields(service_name = "InitialBalances"))]
    ...
    #[tracing::instrument(skip(self, chain_config, storage_diffs), fields(service_name = "InitialBalances"))]
