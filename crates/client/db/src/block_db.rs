...
impl MadaraBackend {
    ...
    #[tracing::instrument(skip(self), fields(service_name = "BlockDB"))]
    ...
    #[tracing::instrument(skip(self, id), fields(service_name = "BlockDB"))]
    ...
    #[tracing::instrument(skip(self, tx_hash), fields(service_name = "BlockDB"))]
