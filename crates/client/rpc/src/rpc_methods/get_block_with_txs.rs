...
pub use mc_rpc_core::{Felt, GetBlockWithTxsServer, StarknetTraceRpcApiServer, StarknetWriteRpcApiServer};
...
impl<A, B, BE, G, C, P, H> GetBlockWithTxsServer for Starknet<A, B, BE, G, C, P, H>
where
