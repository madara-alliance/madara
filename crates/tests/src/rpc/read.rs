...
async fn test_get_block_txn_count_works(mut madara: MadaraCmd) {
    ...
    assert_eq!(madara.json_rpc().get_block_transaction_count(BlockId::Number(2)).await.unwrap(), 1);
}
...
#[rstest]
#[tokio::test]
async fn test_call_works(mut madara: MadaraCmd) {
    madara.wait_for_ready().await;
    madara.wait_for_sync_to(19).await;
...
#[rstest]
#[tokio::test]
async fn test_get_class_works(mut madara: MadaraCmd) {
    madara.wait_for_ready().await;
    madara.wait_for_sync_to(19).await;
...
#[rstest]
#[tokio::test]
async fn test_get_class_at_works(mut madara: MadaraCmd) {
    madara.wait_for_ready().await;
    madara.wait_for_sync_to(19).await;
