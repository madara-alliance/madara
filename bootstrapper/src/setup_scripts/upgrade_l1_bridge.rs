...
abigen!(EthereumNewBridge, "../build-artifacts/starkgate_latest/solidity/ethBridge.json");
abigen!(EthereumNewBridgeEIC, "../build-artifacts/starkgate_latest/solidity/ethBridgeEIC.json");
