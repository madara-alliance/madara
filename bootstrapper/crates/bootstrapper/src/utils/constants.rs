...
pub const ARGENT_ACCOUNT_CASM_PATH: &str = "../../../artifacts/ArgentAccount.casm.json";
pub const BRAAVOS_ACCOUNT_SIERRA_PATH: &str = "../../../artifacts/BraavosAccount.sierra.json";
...
pub const NEW_ETH_BRIDGE_CASM_PATH: &str = "../../../artifacts/token_bridge.casm.json";
