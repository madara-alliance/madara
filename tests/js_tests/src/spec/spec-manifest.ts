 ...
 *
 * Prefer stable upstream tags when available. The SHA-256 checksums act as an
 * additional content pin — if upstream updates a spec file, the checksum
 * mismatch will fail explicitly, prompting a manual review and re-pin of the
 * new checksums.
 */
