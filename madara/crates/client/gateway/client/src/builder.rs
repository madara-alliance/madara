...
impl GatewayProvider {
    pub fn with_madara_specific_url(mut self, madara_specific_url: Url) -> Self {
    ...
    pub fn new_from_base_path(base_path: Url) -> Self {
        Self::new(
            base_path.join("/gateway").expect("Appending constant to URL"),
            base_path.join("/feeder_gateway").expect("Appending constant to URL"),
        )
        .with_madara_specific_url(base_path.join("/madara").expect("Appending constant to URL"))
    }
