...
use mp_rpc::v0_10_0::{TxnExecutionStatus, TxnFinalityAndExecutionStatus, TxnStatus};
...
///
/// [`Received`]: mp_rpc::v0_10_0::TxnStatus::Received
/// [`Candidate`]: mp_rpc::v0_10_0::TxnStatus::Candidate
/// [`PreConfirmed`]: mp_rpc::v0_10_0::TxnStatus::PreConfirmed
/// [`AcceptedOnL2`]: mp_rpc::v0_10_0::TxnStatus::AcceptedOnL2
/// [`AcceptedOnL1`]: mp_rpc::v0_10_0::TxnStatus::AcceptedOnL1
...
mod tests {
    ...
    #[rstest::fixture]
    fn tx() -> mp_rpc::v0_10_0::BroadcastedInvokeTxn {
        mp_rpc::v0_10_0::BroadcastedInvokeTxn::V3(mp_rpc::v0_10_0::InvokeTxnV3 {
    ...
    #[rstest::fixture]
    fn tx_with_receipt(tx: mp_rpc::v0_10_0::BroadcastedInvokeTxn) -> mp_block::TransactionWithReceipt {
    ...
    #[tokio::test]
    #[rstest::rstest]
    async fn get_transaction_status_received(_logs: (), starknet: Starknet, tx: mp_rpc::v0_10_0::BroadcastedInvokeTxn) {
    ...
    async fn get_transaction_status_accepted_on_l2(
        ...
        assert_eq!(
            ...
            TxnFinalityAndExecutionStatus {
                ...
                execution_status: Some(mp_rpc::v0_10_0::TxnExecutionStatus::Succeeded)
            }
        );
    }
