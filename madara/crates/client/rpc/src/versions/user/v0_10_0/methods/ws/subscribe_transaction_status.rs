...
async fn send_txn_status(
    ...
    let status = match snapshot {
        crate::TxStatusSnapshot::Received => mp_rpc::v0_10_0::TxnStatus::Received,
        crate::TxStatusSnapshot::Candidate => mp_rpc::v0_10_0::TxnStatus::Candidate,
        crate::TxStatusSnapshot::PreConfirmed => mp_rpc::v0_10_0::TxnStatus::PreConfirmed,
        crate::TxStatusSnapshot::AcceptedOnL2 => mp_rpc::v0_10_0::TxnStatus::AcceptedOnL2,
        crate::TxStatusSnapshot::AcceptedOnL1 => mp_rpc::v0_10_0::TxnStatus::AcceptedOnL1,
    };
