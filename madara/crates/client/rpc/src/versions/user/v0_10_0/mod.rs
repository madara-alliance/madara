...
type SubscriptionItemTransactionStatus = mp_rpc::v0_10_0::NewTxnStatus;
...
pub trait StarknetWsRpcApi {
    ...
    async fn subscribe_events(
        ...
        finality_status: Option<mp_rpc::v0_10_0::FinalityStatus>,
    ...
    async fn subscribe_new_transactions(
        &self,
        finality_status: Option<Vec<mp_rpc::v0_10_0::TxnStatusWithoutL1>>,
    ...
    async fn subscribe_new_transaction_receipts(
        &self,
        finality_status: Option<Vec<mp_rpc::v0_10_0::FinalityStatus>>,
        sender_address: Option<Vec<starknet_types_core::felt::Felt>>,
    ) -> jsonrpsee::core::SubscriptionResult;
