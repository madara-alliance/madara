...
type SubscriptionItemPendingTxs = methods::ws::SubscriptionItem<mp_rpc::v0_10_0::TxnReceiptWithBlockInfo>;
type SubscriptionItemEvents = methods::ws::SubscriptionItem<mp_rpc::v0_10_0::EmittedEvent>;
