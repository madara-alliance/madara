...
pub trait StarknetReadRpcApi {
    ...
    #[method(name = "blockNumber", and_versions = ["V0_8_1", "V0_9_0"])]
    fn block_number(&self) -> RpcResult<u64>;

    // Get the most recent accepted block hash and number
    #[method(name = "blockHashAndNumber", and_versions = ["V0_8_1", "V0_9_0"])]
    ...
    /// Get the chain id
    #[method(name = "chainId", and_versions = ["V0_8_1", "V0_9_0"])]
    fn chain_id(&self) -> RpcResult<Felt>;

    /// Get the number of transactions in a block given a block id
    #[method(name = "getBlockTransactionCount", and_versions = ["V0_8_1"])]
    ...
    #[method(name = "syncing", and_versions = ["V0_8_1", "V0_9_0"])]
