...
const UDC_CLASS_DEFINITION: &[u8] = include_bytes!("../../../../../build_artifacts/cairo/madara_contracts_UDC.json");
...
const ERC20_CLASS_DEFINITION: &[u8] =
    include_bytes!("../../../../../build_artifacts/cairo/openzeppelin_ERC20Upgradeable.contract_class.json");
...
const ACCOUNT_CLASS_DEFINITION: &[u8] =
    include_bytes!("../../../../../build_artifacts/cairo/openzeppelin_AccountUpgradeable.contract_class.json");
