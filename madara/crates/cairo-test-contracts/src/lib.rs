...
pub const TEST_CONTRACT_SIERRA: &[u8] =
    include_bytes!("../../../../build_artifacts/cairo/madara_contracts_TestContract.contract_class.json");
pub const APPCHAIN_CONTRACT_SIERRA: &[u8] =
    include_bytes!("../../../../build_artifacts/cairo/madara_contracts_StateUpdateContract.contract_class.json");
pub const MESSAGING_CONTRACT_SIERRA: &[u8] =
    include_bytes!("../../../../build_artifacts/cairo/madara_contracts_MessagingContract.contract_class.json");
