...
/// Simulation flag (MODIFIED in v0.10.2)
///
...
pub enum SimulationFlag {
    ...
    SkipValidate,
    /// Return the initial reads (storage, nonces, class_hashes) during simulation (NEW in v0.10.2)
    #[serde(rename = "RETURN_INITIAL_READS")]
    ReturnInitialReads,
}

/// Trace flag for traceBlockTransactions (NEW in v0.10.2)
///
...
/// Initial storage read item (NEW in v0.10.2)
///
...
/// Initial nonce read item (NEW in v0.10.2)
///
...
/// Initial class hash read item (NEW in v0.10.2)
///
...
/// Initial declared contract item (NEW in v0.10.2)
///
...
/// Complete initial reads structure (NEW in v0.10.2)
///
...
/// Result of simulating a single transaction (MODIFIED in v0.10.2)
///
