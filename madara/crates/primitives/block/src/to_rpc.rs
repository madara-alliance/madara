...
impl MadaraBlockInfo {
    ...
    pub fn to_rpc_v0_10(&self) -> mp_rpc::v0_10_0::BlockHeader {
        self.header.to_rpc_v0_10(self.block_hash)
    }
}
...
impl Header {
    ...
    pub fn to_rpc_v0_10(&self, block_hash: Felt) -> mp_rpc::v0_10_0::BlockHeader {
        mp_rpc::v0_10_0::BlockHeader {
            l1_da_mode: self.l1_da_mode.into(),
            l1_data_gas_price: self.gas_prices.l1_data_gas_price(),
            l1_gas_price: self.gas_prices.l1_gas_price(),
            l2_gas_price: self.gas_prices.l2_gas_price(),
            ...
            receipt_commitment: self.receipt_commitment.unwrap_or(Felt::ZERO),
            state_diff_commitment: self.state_diff_commitment.unwrap_or(Felt::ZERO),
            event_count: self.event_count,
            transaction_count: self.transaction_count,
            state_diff_length: self.state_diff_length.unwrap_or(0),
        }
    }
}
